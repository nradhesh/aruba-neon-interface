  ...
  const services = [
    {
      ...
      description: 'Search through technical documentation and knowledge base',
      icon: FileText,
      color: 'neon-blue',
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold neon-text">AI Assistant</h2>
          </div>
          <ChatInterface />
        </div>
        ...
        <div className="glass-morphism rounded-xl p-6 mt-12">
          <h3 className="text-xl font-bold text-neon-blue mb-4">🔧 API Integration Points</h3>
          <div className="space-y-2 text-sm text-gray-300">
            <p>• <strong>Base API URL:</strong> <code className="bg-gray-800 px-2 py-1 rounded">// Insert your base API URL here</code></p>
            <p>• <strong>Authentication:</strong> <code className="bg-gray-800 px-2 py-1 rounded">// Add your API authentication headers here</code></p>
            <p>• <strong>Chat Endpoint:</strong> <code className="bg-gray-800 px-2 py-1 rounded">// Insert chatbot API endpoint here</code></p>
            <p>• Each service card contains its specific API endpoint in the component props</p>
            <p>• WebSocket connection for real-time chat: <code className="bg-gray-800 px-2 py-1 rounded">// Insert WebSocket URL here</code></p>
          </div>
        </div>
      </main>
    </div>
